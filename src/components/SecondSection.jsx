...
//                 <span className="px-4 py-2 rounded-[30px] mb-4 border border-white shadow shadow-white bg-[#A200F5]/10 text-[#A200F5] text-[16px] sm:text-[18px] inline-block">
//                     Why Most EAs Fail
//                 </span>
//                 <h2 className="text-2xl sm:text-3xl md:text-[40px] text-white mb-8 leading-tight">
