                ...
                <div className="relative">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 z-0">
                        {strategies.map((item, idx) => (
                            <div key={idx} className={`bg-[#3C3C3C] ${idx % 2 === 0 ? "pr-6 pl-16" : "pr-16 pl-6"} py-6 rounded-lg opacity-80`}>
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="">
                                        <h3 className="text-[18px] font-bold mb-0">{item.title}</h3>
                    ...
                    <div className="h-full w-[120px] block absolute left-0 top-0 bg-gradient-to-r from-[#121212] to-transparent z-10"></div>
                    <div className="h-full w-[120px] block absolute right-0 top-0 bg-gradient-to-l from-[#121212] to-transparent z-10"></div>
                </div>
            </div>
        </section>
    );
