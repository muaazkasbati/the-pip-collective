...
//       <div className="bg-[#121212] flex flex-col md:flex-row md:items-end items-center overflow-hidden max-w-7xl mx-auto shadow-2xl shadow-white/10 rounded-xl">
...
//         {/* Content */}
//         <div className="w-full md:w-2/3 text-center md:text-left py-8 px-4">
