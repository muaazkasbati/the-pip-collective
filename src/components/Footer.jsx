...
// export default function Footer() {
//     return (
//         <footer className="pt-12 pb-10 border-t border-white/5">
...
//                 <div className="flex flex-col sm:flex-row justify-between items-center mt-12 gap-4 text-center">
...
export default function Footer() {
    return (
        <motion.footer
            className="pt-12 pb-10 border-t border-white/5"
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
