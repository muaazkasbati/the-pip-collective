    ...
    return (
        <section className="py-16 px-4 sm:px-6 relative overflow-hidden">
            <motion.div
                ...
                className="max-w-7xl mx-auto text-center shadow-[inset_0_0_10px_#ffffff44] pt-10 pb-12 px-4 sm:px-8 md:px-20 rounded-[12px]"
            >
                <motion.span
                ...
                <motion.h3
                    ...
                    className="text-2xl sm:text-4xl md:text-[48px] font-bold bg-gradient-to-r [background-image:linear-gradient(to_right,_white_30%,_#A200F5_80%)] bg-clip-text text-transparent mb-6"
                >
                    Built On Quant Logic
                </motion.h3>
