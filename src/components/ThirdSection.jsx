...
export default function ThirdSection() {
    ...
    return (
        <section id="copy-trade" className="py-16 px-4 sm:px-6 relative overflow-hidden">
            <motion.div
                ref={ref}
                ...
                <div className='relative z-10'>
                    ...
                    {/* <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {features.map((item, idx) => {
                            const imgControls = imgControllers[idx];
                            ...
                            return (
                                <motion.div
                                    ...
                                    onHoverStart={() => imgControls.start({ scale: 1.1 })}
                                    onHoverEnd={() => imgControls.start({ scale: 1 })}
                                    // className="group bg-white/10 backdrop-blur-lg p-4 sm:p-6 rounded-2xl text-start relative overflow-hidden before:absolute before:top-0 before:left-0 before:h-full before:w-full before:opacity-10 before:bg-[url('/images/noise.jpg')] before:bg-cover before:bg-blend-overlay"
                                    className="group bg-white/10 backdrop-blur-lg p-4 sm:p-6 rounded-2xl text-start relative overflow-hidden before:absolute before:top-0 before:left-0 before:h-full before:w-full before:opacity-10 before:bg-[url('/images/noise.jpg')] before:bg-cover before:bg-blend-overlay"
